...
const FirebaseLogin = ({ ...others }) => {
    ...
    const handleSubmit = async (credentials, setErrors, setStatus, setSubmitting) => {
        try {
                    ...
                    <form noValidate onSubmit={handleSubmit} {...others}>
                        ...
                        <Box sx={{ mt: 2 }}>
                            <AnimateButton>
                                <Button
                                    disableElevation
                                    disabled={isSubmitting || Object.keys(errors).length !== 0 && !errors.submit}
                                    fullWidth
                                    size="large"
                                    type="submit"
                                    variant="contained"
